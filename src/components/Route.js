...
import DashBoardLoading from './Dashboard/dash_loading';
import CalenderLoading from './Dashboard/calender_loading';
import EmailLoading from './Dashboard/email_loading'
import DriverInbox from './Email/dirver_inbox'
...
const Routes = [
    {
        ...
        name: 'PlanCalender',
        exact: true,
        pageTitle: "PlanCalender",
        component: PlannerCalender
    },
    {
        path: "/driver-calender",
        name: 'DriverCalender',
        exact: true,
        pageTitle: "DriverCalender",
        component: DriverCalender
    },
    {
        path: "/dash-loading",
        name: 'DashLoading',
        exact: true,
        pageTitle: "DashLoading",
    ...
    },
    {
        ...
        name: 'EmailLoading',
        exact: true,
        pageTitle: "EmailLoading",
        component: EmailLoading,
    },
    {
        path: "/cal-loading",
        name: 'CalLoading',
        exact: true,
        pageTitle: "CalLoading",
        component: CalenderLoading
    },
    {
        path: "/ui-nestable",
        name: 'Nestable',
